...
@XmlRootElement
public class Joo2_virtuemart_order_userinfos implements Serializable 
{
    @Id
    @GeneratedValue
    @Column(name="virtuemart_order_userinfo_id")
    private Integer epgen_virtuemart_order_userinfo_id;
    ...
    private String epgen_virtuemart_state_id;
    @Column(name="virtuemart_country_id")
    private String epgen_virtuemart_country_id;
    @Column(name="zip")
	...
	public Integer getepgen_virtuemart_order_userinfo_id() {
		return epgen_virtuemart_order_userinfo_id;
	}

	public void setepgen_virtuemart_order_userinfo_id(Integer epgen_virtuemart_order_userinfo_id) {
		this.epgen_virtuemart_order_userinfo_id = epgen_virtuemart_order_userinfo_id;
	}
	...
	public String getepgen_virtuemart_state_id() {
		return epgen_virtuemart_state_id;
	}

	public void setepgen_virtuemart_state_id(String epgen_virtuemart_state_id) {
		this.epgen_virtuemart_state_id = epgen_virtuemart_state_id;
	}
	public String getepgen_virtuemart_country_id() {
		return epgen_virtuemart_country_id;
	}

	public void setepgen_virtuemart_country_id(String epgen_virtuemart_country_id) {
