...
@Entity
@Table(name = "joo2_virtuemart_product_customfields", catalog = "lakida_03", schema = "", uniqueConstraints = {
@UniqueConstraint(columnNames = {"name"})})
@XmlRootElement
public class Joo2_virtuemart_product_customfields implements Serializable 
{
    @Id
    @GeneratedValue
    @Column(name="virtuemart_customfield_id")
    private Integer epgen_virtuemart_customfield_id;
    ...
    private String epgen_custom_price;
	...
	public Integer getepgen_virtuemart_customfield_id() {
		return epgen_virtuemart_customfield_id;
	}

	public void setepgen_virtuemart_customfield_id(Integer epgen_virtuemart_customfield_id) {
		this.epgen_virtuemart_customfield_id = epgen_virtuemart_customfield_id;
	}
	...
	public String getepgen_custom_price() {
		return epgen_custom_price;
	}

	public void setepgen_custom_price(String epgen_custom_price) {
		this.epgen_custom_price = epgen_custom_price;
	}
