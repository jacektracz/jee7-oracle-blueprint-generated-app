...
@XmlRootElement
public class Joo2_virtuemart_creditcards implements Serializable 
{
    @Id
    @GeneratedValue
    ...
    private String epgen_creditcard_name;
    @Column(name="creditcard_code")
    private String epgen_creditcard_code;
	...
	public String getepgen_creditcard_name() {
		return epgen_creditcard_name;
	}

	public void setepgen_creditcard_name(String epgen_creditcard_name) {
		this.epgen_creditcard_name = epgen_creditcard_name;
	}
	public String getepgen_creditcard_code() {
		return epgen_creditcard_code;
	}

	public void setepgen_creditcard_code(String epgen_creditcard_code) {
		this.epgen_creditcard_code = epgen_creditcard_code;
	}
