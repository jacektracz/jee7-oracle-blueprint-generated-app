...
@Entity
@Table(name = "joo2_kunena_subscriptions_categories", catalog = "lakida_03", schema = "", uniqueConstraints = {
@UniqueConstraint(columnNames = {"name"})})
@XmlRootElement
public class Joo2_kunena_subscriptions_categories implements Serializable 
{
    @Id
    @GeneratedValue
    @Column(name="catid")
