...
public class CustomersController implements Serializable {
    ...
    @EJB
    private etp.vm.gen.session.CustomersFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(JsfUtil.getM("Customers Created"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(JsfUtil.getM("Customers Updated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, JsfUtil.getM("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(JsfUtil.getM("Customers Deleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, JsfUtil.getM("PersistenceErrorOccured"));
        }
    }
