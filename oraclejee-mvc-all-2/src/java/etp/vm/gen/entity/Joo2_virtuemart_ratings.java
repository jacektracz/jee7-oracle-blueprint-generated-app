...
@XmlRootElement
public class Joo2_virtuemart_ratings implements Serializable 
{
    @Id
    @GeneratedValue
    ...
    @Column(name="rates")
    private Integer epgen_rates;
    @Column(name="ratingcount")
    private Integer epgen_ratingcount;
	...
	public Integer getepgen_rates() {
		return epgen_rates;
	}

	public void setepgen_rates(Integer epgen_rates) {
		this.epgen_rates = epgen_rates;
	}
	public Integer getepgen_ratingcount() {
		return epgen_ratingcount;
	}

	public void setepgen_ratingcount(Integer epgen_ratingcount) {
		this.epgen_ratingcount = epgen_ratingcount;
	}
