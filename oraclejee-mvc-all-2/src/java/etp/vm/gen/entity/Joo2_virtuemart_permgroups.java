...
@XmlRootElement
public class Joo2_virtuemart_permgroups implements Serializable 
{
    @Id
    @GeneratedValue
    ...
    private String epgen_group_name;
    @Column(name="group_level")
    private Integer epgen_group_level;
	...
	public String getepgen_group_name() {
		return epgen_group_name;
	}

	public void setepgen_group_name(String epgen_group_name) {
		this.epgen_group_name = epgen_group_name;
	}
	public Integer getepgen_group_level() {
		return epgen_group_level;
	}

	public void setepgen_group_level(Integer epgen_group_level) {
		this.epgen_group_level = epgen_group_level;
	}
