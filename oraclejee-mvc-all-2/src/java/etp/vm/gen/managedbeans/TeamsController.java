...
import etp.vm.gen.session.TeamsFacade;
...
public class TeamsController implements Serializable {
    ...
    @EJB
    private etp.vm.gen.session.TeamsFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(JsfUtil.getM("Teams Created"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(JsfUtil.getM("Teams Updated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, JsfUtil.getM("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(JsfUtil.getM("Teams Deleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, JsfUtil.getM("PersistenceErrorOccured"));
        }
    }
