...
@Entity
@Table(name = "joo2_virtuemart_product_categories", catalog = "lakida_03", schema = "", uniqueConstraints = {
@UniqueConstraint(columnNames = {"name"})})
@XmlRootElement
public class Joo2_virtuemart_product_categories implements Serializable 
{
    @Id
    @GeneratedValue
    @Column(name="id")
